  ...
  return (
    <footer className="bg-[var(--ink)] text-white/55">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 py-16 grid grid-cols-1 md:grid-cols-3 gap-12" dir="rtl">
        ...
        {/* brand */}
        <div>
          <p className="font-cairo text-2xl font-light text-white mb-1">زهور الفخامة</p>
          <p className="label text-[8px] text-[var(--sky)] mb-6">Luxury Blooms · Doha</p>
        ...
        {/* links */}
        <div>
          <p className="label text-[9px] text-[var(--sky)] mb-6">روابط</p>
          <ul className="flex flex-col gap-3.5 text-sm">
            {[
              ...
              <li key={href}>
                <Link href={href} className="text-white/45 hover:text-[var(--sky)] transition-colors">{ar}</Link>
              </li>
            ))}
          </ul>
        </div>
        ...
        {/* contact */}
        <div>
          <p className="label text-[9px] text-[var(--sky)] mb-6">تواصل</p>
          <ul className="flex flex-col gap-4 text-sm text-white/45">
            {[
              ...
              <li key={text} className="flex items-start gap-3">
                ...
                {href
                  ? <a href={href} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--sky)] transition-colors">{text}</a>
                  : <span>{text}</span>
                }
              </li>
            ))}
      ...
      <div className="border-t border-white/[0.06] py-5 text-center label text-[8px] text-white/20">
